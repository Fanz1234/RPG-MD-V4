...
const sections = [
   {
	...
	rows: [
        {title: "✎ • downloader tiktok V1", rowId: `.vidio ${args[0]}`, description: 'download Vidio tiktok Kamu di FanzBotzz' },
        {title: "✎ • downloader tiktok V2", rowId: `.ttkneoxr ${args[0]}`, description: 'download Vidio tiktok Kamu di FanzBotzz' },
        ]
    },
]
